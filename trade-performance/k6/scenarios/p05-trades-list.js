 ...
 * [How to run] ./k6/run.sh p05-trades-list dev smoke
 *          ./k6/run.sh p05-trades-list dev arrival RATE=4        # steady state 4.13 TPS
 *          ./k6/run.sh p05-trades-list dev arrival RATE=33       # design capacity
