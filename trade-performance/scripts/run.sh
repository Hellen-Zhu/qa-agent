...
jmeter -n \
    ...
    -Jsample_variables=runPhase,caseId,tradeId,taskId,datFile,productType,costTier,fixings,datSize,errClass,riskOk,riskFailCode,pairId,portfolioId,effectiveUserId,claimedTaskId,claimedCount,checkerAction,bulkOutcome,bulkSuccessCount,checkerFailMsg,eventCaseId,eventType,needsApproval,eventTaskId,eventFailMsg,tradesRowCount,tradesQuery,targetTradeId \
